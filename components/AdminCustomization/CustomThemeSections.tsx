...
const WEB_SECTIONS = [
  { title: 'Header Section', key: 'headerStyle', label: 'Header', count: 6, icon: '🎯' },
  { title: 'Showcase Section', key: 'showcaseSectionStyle', label: 'Showcase', count: 5, icon: '✨' },
  { title: 'Category Section', key: 'categorySectionStyle', label: 'Category', count: 5, icon: '📂' },
  { title: 'Product Card V2', key: 'productSectionStyle', label: 'Product', count: 5, icon: '🛍️' },
  { title: 'Product Card', key: 'productCardStyle', label: 'Card', count: 5, icon: '🃏' },
  { title: 'Brand Section', key: 'brandSectionStyle', label: 'Brand', count: 5, icon: '🏷️' },
  { title: 'Footer Section', key: 'footerStyle', label: 'Footer', count: 5, icon: '📋' },
];

// Mobile sections configuration
const MOBILE_SECTIONS = [
  { title: 'Mobile Header', key: 'mobileHeaderStyle', label: 'Header', count: 6, icon: '📱' },
  { title: 'Product Card', key: 'productCardStyle', label: 'Card', count: 5, icon: '🃏' },
  { title: 'Bottom Nav', key: 'bottomNavStyle', label: 'Nav', count: 5, icon: '🧭' },
];
...
}> = ({ title, icon, sectionKey, label, count, currentStyle, enabled, isExpanded, onStyleSelect, onToggle, onExpand, demoImages }) => (
  <div style={{
    borderRadius: '14px',
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '16px', minWidth: 0 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '4px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              <h2 style={{ fontFamily: '"Inter", "Lato", sans-serif', fontWeight: 700, fontSize: '18px', color: '#0f172a', margin: 0, letterSpacing: '-0.3px' }}>
                Theme Customizer
              </h2>
              <p style={{ fontFamily: '"Inter", sans-serif', fontSize: '12px', color: '#64748b', margin: '1px 0 0', fontWeight: 400 }}>
          ...
          <div style={{
            ...
            <button
              onClick={() => { setDeviceMode('web'); setExpandedSection('headerStyle'); }}
              style={{
            ...
            <button
              onClick={() => { setDeviceMode('mobile'); setExpandedSection('mobileHeaderStyle'); }}
              style={{
                display: 'flex', alignItems: 'center', gap: '5px',
                padding: '6px 14px', borderRadius: '8px', border: 'none', cursor: 'pointer',
                fontFamily: '"Inter", sans-serif', fontSize: '12.5px', fontWeight: 500,
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              <div>
                <h4 style={{ fontFamily: '"Inter", "Lato", sans-serif', fontWeight: 700, fontSize: '15px', color: '#0f172a', margin: 0 }}>
                  Preview
                </h4>
                <p style={{ margin: 0, fontFamily: '"Inter", sans-serif', fontSize: '11.5px', color: '#94a3b8', fontWeight: 400 }}>
            ...
            <div style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
              <button
                ...
                style={{
                  ...
                  border: previewTab === 'style' ? '1.5px solid #ff6a00' : '1px solid #e5e7eb',
                  cursor: 'pointer',
              ...
              {storeUrl && (
                <>
                  <button
                    ...
                    style={{
                      width: '34px', height: '34px', borderRadius: '8px',
                      border: previewTab === 'store' ? '1.5px solid #ff6a00' : '1px solid #e5e7eb',
                      cursor: 'pointer',
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                      transition: 'all 0.2s ease',
                  ...
                  >
                    <Globe size={14} style={{ color: previewTab === 'store' ? '#ff6a00' : '#94a3b8' }} />
                  </button>
                  <button
            ...
            {previewTab === 'style' ? (
              getPreviewImage() ? (
                ...
                <div style={{
                  ...
                  <div style={{ textAlign: 'center' }}>
                    <p style={{ fontFamily: '"Inter", sans-serif', fontSize: '14px', fontWeight: 600, color: '#64748b', margin: '0 0 4px' }}>No preview available</p>
                    <p style={{ fontFamily: '"Inter", sans-serif', fontSize: '12px', color: '#94a3b8', margin: 0 }}>Select a style to see the preview</p>
                  </div>
                </div>
              )
            ) : (
              storeUrl ? (
                <div style={{
                  ...
                  {isThemeLoading ? (
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '24px', padding: '40px' }}>
                      <div style={{ position: 'relative', width: '72px', height: '72px' }}>
                        <div style={{
                          position: 'absolute', width: '100%', height: '100%',
                          border: '3px solid #f1f5f9', borderTop: '3px solid #ff6a00',
                      ...
                      <div style={{ textAlign: 'center', fontFamily: '"Inter", "Lato", sans-serif' }}>
                    ...
                    <div style={{
                      width: '375px', height: '667px', position: 'relative',
                    ...
                    <iframe
                      ...
                      style={{
                        ...
                        width: '1440px', height: '2240px', border: 'none',
                        transformOrigin: 'top left', transform: 'scale(0.304)',
                      }}
                      sandbox="allow-scripts allow-same-origin allow-popups"
                    />
                  )}
                ...
                <div style={{
                  ...
                  <span style={{ fontFamily: '"Inter", sans-serif', fontSize: '14px', color: '#94a3b8' }}>Store preview unavailable</span>
                </div>
              )
            )}
          </div>
