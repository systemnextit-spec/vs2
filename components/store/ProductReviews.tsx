        ...
        <div className="text-center py-16 px-4">
          ...
          {!showReviewForm && (
            <button
              ...
              className="inline-flex items-center gap-2 px-3 sm:px-4 lg:px-6 py-3 bg-emerald-500 text-white font-semibold rounded-xl hover:bg-emerald-600 transition-all shadow-lg"
            >
